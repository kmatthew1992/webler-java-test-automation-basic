...
public class FindElementExample {
    ...
    public static void main(String[] args) {
        ...
        int indexFoundNumber = foundNumberReturnIndex(numbers, foundNumber);
        int indexNotFoundnumber = foundNumberReturnIndex(numbers, notFoundNumber);
    ...
    private static int foundNumberReturnIndex(int[] numbers, int foundNumber) {
